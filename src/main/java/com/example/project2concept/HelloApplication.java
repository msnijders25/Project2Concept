...
public class HelloApplication extends Application {
    ...
    Chat katChat = new Chat();
    Chat hondChat = new Chat();
    Chat voedselChat = new Chat();
    Chat tekstChat = new Chat();
    private VBox chats;
    private VBox chatContainer;
    private TextArea chatTextArea;

    private TextArea chatGeschiedenis;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        chatGeschiedenis = new TextArea();
        chatGeschiedenis.setPrefSize(600, 530);
